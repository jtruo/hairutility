...
class HairProfile(models.Model):
    ...
    first_image_url = models.CharField(max_length=200, default="")
    second_image_url = models.CharField(max_length=200, default="")
    third_image_url = models.CharField(max_length=200, default="")
    fourth_image_url = models.CharField(max_length=200, default="")
    thumbnail_key = models.CharField(max_length=64, default="")
