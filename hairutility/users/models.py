...
class HairProfile(models.Model):
    ...
    first_image_key = models.CharField(max_length=200, default="")
    second_image_key = models.CharField(max_length=200, default="")
    third_image_key = models.CharField(max_length=200, default="")
    fourth_image_key = models.CharField(max_length=200, default="")
